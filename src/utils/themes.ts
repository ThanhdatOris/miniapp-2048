...
export const defaultLightTheme: Theme = {
  ...
  colors: {
    ...
    tile: {
      ...
      background: {
        ...
        4: 'rgba(59, 130, 246, 0.2)',
        8: 'rgba(139, 92, 246, 0.3)',
        16: 'rgba(139, 92, 246, 0.4)',
        32: 'rgba(245, 158, 11, 0.4)',
        64: 'rgba(245, 158, 11, 0.5)',
        128: 'rgba(239, 68, 68, 0.4)',
        256: 'rgba(239, 68, 68, 0.5)',
        512: 'rgba(239, 68, 68, 0.6)',
        1024: 'rgba(220, 38, 127, 0.6)',
        2048: 'rgba(220, 38, 127, 0.7)',
      },
    },
    text: {
      primary: '#1f2937',
  ...
  gradients: {
    ...
    tile: 'linear-gradient(135deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.1) 100%)',
  },
};
